...
async def play(_, message: Message):
    ...
    if audio:
            ...
            [
                [
                    InlineKeyboardButton(
                        text="Locally added", url=f"https://t.me/"
                    ),
                    InlineKeyboardButton(text="Locally added", url=f"https://t.me/"),
                ]
            ]
        )
        ...
        try:
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="# print results 1", url=f"https://t.me/"
                        ),
                        InlineKeyboardButton(
                            text="# print results 1", url=f"https://t.me/"
                        ),
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="nan URL 1", url=f"https://t.me/"
                        ),
                        InlineKeyboardButton(
                            text="nan URL 2", url=f"https://t.me/"
                        ),
                    ]
                ]
            )
        if (dur / 60) > DURATION_LIMIT:
            await lel.edit(
                f"**Video Longer Than** {DURATION_LIMIT} **Minuts Arnt't Allowd to Play Sorry....**"
            )
            return
        requested_by = message.from_user.first_name
        await generate_cover(requested_by, title, views, duration, thumbnail)
        ...
        try:
            ...
            await lel.edit("Spelling Problem...")
            print(str(e))
            return
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text="known URL 1", url=f"https://t.me/"
                    ),
                    InlineKeyboardButton(text="Known URL 2", url=f"https://t.me/"),
                ]
            ]
        )
